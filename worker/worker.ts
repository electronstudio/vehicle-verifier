...
// This worker acts as a CORS proxy for the DVLA Vehicle Enquiry API

export default {
  async fetch(request: Request, env: { DVLA_API_KEY: string }): Promise<Response> {
    ...
    try {
      ...
      // Parse request body
      let requestBody: { registrationNumber: string };
      try {
